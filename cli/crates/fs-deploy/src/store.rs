...
//
// Architecture:
//   fs_store::StoreClient  — generic I/O: Local or Http
//   StoreClient (this file) — FSN-specific: wraps fs-store, adds git sync,
//                             multi-store merge, bundled offline fallback.
//
// Two modes:
//   fetch_all()     — catalog only (for browsing). Uses fs_store::StoreClient.
