// Module plugin runner — delegates to fs-plugin-runtime.
//
// Dispatch priority:
...
impl ContextBuilder {
    ...
    pub fn build(
        command: &str,
        instance: &fs_node_core::state::desired::ServiceInstance,
        project_domain: &str,
        data_root: &str,
        peers: &[&fs_node_core::state::desired::ServiceInstance],
    ) -> PluginContext {
