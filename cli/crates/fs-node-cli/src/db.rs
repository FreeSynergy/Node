...
//   fsn.db       — audit log + core migrations (fs-db Migrator)
//   fs-core.db  — hosts, projects, invitations, federation
//   fs-bus.db   — event log, subscriptions, routing rules, standing orders
