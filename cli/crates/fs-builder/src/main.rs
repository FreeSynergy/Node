...
//!
//! ```text
//! fs-builder analyze  <compose.yml>    — Docker Compose → ContainerResource
//! fs-builder validate <package-dir>    — validate a resource package
//! fs-builder publish  <package-dir>    — sign + git-commit + push to Store
//! ```
...
enum Command {
    ...
    ///
    /// Example: fs-builder fetch-icon homarr:kanidm kanidm --store-dir /path/to/Store
    FetchIcon {
